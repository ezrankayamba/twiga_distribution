...
class CrudTable extends React.Component {
    ...
    render() {
        const {columns, data, onRowClick, isLoading, newRecord, pagination, onSearch} = this.props
        ...
        return (
            <div className="bg-light p-2">
                {searchFields.length > 0 && <SearchForm onSearch={onSearch} searchFields={searchFields}/>}

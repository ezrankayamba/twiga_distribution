...
export const SearchForm = ({searchFields, onSearch}) => {
    ...
    return (
        <div className="container small">
            <div className="pl-3 row d-md-flex search border border-top-0 border-left-0 border-right-0">
                ...
                <div className="mt-auto pb-2 col-md-auto p-0">
                    <div className="row mr-0 ml-0">
                        <div className="col p-0 pr-1">
                            <button type="button" className="btn btn-outline-secondary float-right pt-2 pb-2" onClick={search}>
                                <IconSearch/> <span
